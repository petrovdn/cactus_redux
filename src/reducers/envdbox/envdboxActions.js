...
export function getActivitylist (sessionToken) {
  var listViewData = [
      [1, '01', false, 'Бытовые услуги', 'Оказание бытовых услуг'],
      [2, '02', false, 'Ветеринарные услуги', 'Оказание ветеринарных услуг'],
      [3, '03', false, 'Услуги для автовладельцев', 'Оказание услуг по ремонту, техническому обслуживанию и мойке автомототранспортных средств'],
      [4, '04', false, 'Стоянка и хранение автотранспорта', 'Оказание услуг по предоставлению во временное владение (в пользование) мест для стоянки автомототранспортных средств, а также по хранению автомототранспортных средств на платных стоянках'],
      [5, '05', false, 'Перевозка грузов на автотранспорте', 'Оказание автотранспортных услуг по перевозке грузов'],
      [6, '06', false, 'Перевозка пассажиров на автотранспорте', 'Оказание автотранспортных услуг по перевозке пассажиров'],
      [7, '07', false, 'Розничная торговля в торговых залах', 'Розничная торговля, осуществляемая через объекты стационарной торговой сети, имеющие торговые залы'],
      [8, '08', false, 'Нестационарная торговля на площади до 5м2', 'Розничная торговля, осуществляемая через объекты стационарной торговой сети, не имеющие торговых залов, а также через объекты нестационарной торговой сети, площадь торгового места в которых не превышает 5 квадратных метров']
  ]
  return dispatch => {
    dispatch(getActivitylistRequest())
    setTimeout(() => {
